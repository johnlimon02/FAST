                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <ass=a class= "btn btn-link" href="{{ route('password.request') }}">
...
<script src="https://www.gstatic.com/firebasejs/9.9.2/firebase-analytics.js"></script>
...
<script>
  ...
  const firebaseConfig = {
    ...
    appId: "1:448331676970:web:e9af3458dcf9e1fc70f253",
    measurementId: "G-5DHJ4W1JM5"
  };
