...
@section('title', 'FAST Edit Products')
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url ('shop_owner/update-products/'.$key) }}" method="post">
                        @csrf
                        @method('PUT')

                        <div class="form-group mb-3">
                            <label>Image</label>
                            <input type="file" name="image" value="{{ $editdata['images'] }}" class="form-control">
                        </div>

                        <div class="form-group mb-3">
                            <label>Date Created</label>
                            <input type="date" name="product_date" value="{{ $editdata['date_created'] }}" class="form-control">
                        </div>

                        <div class="form-group mb-3">
                            <label>Product Name</label>
                            <input type="text" name="product_name" value="{{ $editdata['product_name'] }}" class="form-control">
                        </div>
