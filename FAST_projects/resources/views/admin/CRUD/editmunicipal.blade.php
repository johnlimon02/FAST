...
@section('title', 'FAST Edit Municipality ')
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <form action="{{ url ('admin/update-municipal/'.$key) }}" method="post">
                        @csrf
                        @method('PUT')

                        <div class="form-group mb-3">
                            <label>Municipality Name</label>
                            <input type="text" name="munName" value="{{ $editdata['municipal_name'] }}" class="form-control">
                        </div>

                        <div class="form-group mb-3">
                            <label>Date Created</label>
                            <input type="date" name="munDate" value="{{ $editdata['municipal_date'] }}" class="form-control">
                        </div>
                        <div class="form-group mb-3">
